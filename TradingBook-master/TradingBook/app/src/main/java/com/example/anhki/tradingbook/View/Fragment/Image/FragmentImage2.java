...
public class FragmentImage2 extends Fragment {
    ImageView imageView;
    Bundle bundle;
    public static FragmentImage2 newInstance() {
        return new FragmentImage2();
    }
...
//            imageView.setImageBitmap(bmp);
            ...
            StorageReference storageImgProductType = FirebaseStorage.getInstance().getReference().child("Product").child(bundle.getString("picture2"));
