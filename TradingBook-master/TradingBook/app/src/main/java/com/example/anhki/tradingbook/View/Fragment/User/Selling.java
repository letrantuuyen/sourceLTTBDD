...
public class Selling extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerProduct = (RecyclerView) view.findViewById(R.id.recyclerSelling);

        productController = new ProductController(getApplicationContext());
        productController.getDanhSachSanPhamTheoNguoiBanController(LoginActivity.Current_IdUser, recyclerProduct);
