...
public class Waiting extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerProduct = (RecyclerView) view.findViewById(R.id.recyclerWaiting);

        productController = new ProductController(getApplicationContext());
        productController.getDanhSachSanPhamChuaDuyetController(LoginActivity.Current_IdUser,recyclerProduct);
