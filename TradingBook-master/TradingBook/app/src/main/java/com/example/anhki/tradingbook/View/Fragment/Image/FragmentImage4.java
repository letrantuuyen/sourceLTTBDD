...
public class FragmentImage4 extends Fragment {
    ImageView imageView;
    Bundle bundle;
    public static FragmentImage4 newInstance() {
        return new FragmentImage4();
    }

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_image_4, container, false);
...
//            imageView.setImageBitmap(bmp);
            ...
            StorageReference storageImgProductType = FirebaseStorage.getInstance().getReference().child("Product").child(bundle.getString("picture4"));
