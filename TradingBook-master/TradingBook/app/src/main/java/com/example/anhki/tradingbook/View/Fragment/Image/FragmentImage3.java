...
public class FragmentImage3 extends Fragment {
    ImageView imageView;
    Bundle bundle;
    public static FragmentImage3 newInstance() {
        return new FragmentImage3();
    }

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_image_3, container, false);
...
//            imageView.setImageBitmap(bmp);
            ...
            StorageReference storageImgProductType = FirebaseStorage.getInstance().getReference().child("Product").child(bundle.getString("picture3"));
